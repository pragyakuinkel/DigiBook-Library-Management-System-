<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="flex row mt-4 w-100" style="justify-content:center;">
            ...
            <a class="underline text-sm main_text_color rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800 w-80" href="{{ route('login') }}">
                {{ __(' Login') }}
            </a>
        </div>
    </form>
