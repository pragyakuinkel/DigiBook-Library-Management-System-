            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="mt-3 text_color">
                        <h2 style="font-weight:bold;font-size:30px;width:fit-content">Reviews on {{$publisher->name}}</h2>
                        @foreach($reviews as $review)
                            @if($review->publisher_id==$publisher->id)
                    ...
                    <div class="mt-3">
                        <form action="{{ url('reviews/Publishers/' . $publisher->id) }}" method="post">
                            @csrf
                            <div class="mb-4">
                            ...
                            <div class="text-right">
                                <button type="submit" class="px-6 py-2 text-white bg-blue-600 rounded-md main_color">
                                    Submit Review
                                </button>
                            </div>
                        </form>
