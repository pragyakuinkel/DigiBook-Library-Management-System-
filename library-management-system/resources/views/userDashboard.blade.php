        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="card-group flex text_color mb-4 " style="flex-wrap:wrap;border-radius: 15px;justify-content:center">
                        ...
                        <div class="flex flex-col book" style="transition: all 0.3s ease;align-items:center;max-width:20%;min-width:150px;margin:10px">
                            ...
                            @auth
                                <a href="{{ route('book', $book->id,Auth::user()->id) }}"class="main_color text-white btn px-2 py-1 rounded mt-1 text-center read-more " type="submit" style="padding:6px 18px;margin-top:auto; margin-bottom:10px;width:90%">Read More</a>
                                @endauth
